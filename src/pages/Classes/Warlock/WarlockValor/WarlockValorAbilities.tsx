...
import WarlockValorAssets from "./abilities/WarlockValorAssets";
import WarlockValorHits from "./abilities/WarlockValorHits";
import WarlockValorEquipment from "./abilities/WarlockValorEquipment";
import WarlockValorInspiration from "./abilities/WarlockValorInspiration";
...
export default function WarlockValorAbilities({ render }: { render: boolean }) {
  ...
  return render ? (
    <>
      ...
      >
        ...
        />
        <Ability
          children={<><WarlockValorEquipment /></>}
          bg={abBg.equipment}
          img={abImg.equipment}
          heading="Уміння варвара"
          lvl="1-й рівень"
        ...
        />
        <Ability
          children={<><WarlockValorInspiration /></>}
          bg={abBg.inspiration}
