...
export default function WarlockValorSpells({render}: {render: boolean}) {
  return render ? (
    <>
       <ClassesBottomNavBar
        path1="/WarlockAbilities?option=2"
        path2="/WarlockDescriptions?option=2"
        path3="/WarlockSpells?option=2"
        path4="/WarlockImgs?option=2"
      />
      <div className="wrapper classes-wrapper-margin flex-column" style={{ marginBottom: "65px"}}>
        <SpellCard
          lvl="1"
          spellType="Виклик"
          spellName="Чарівна рука варвара"
          components={
            <>
              <B_Component />
              <C_Component />
        ...
        >
          ...
          <p>Невелика кількість гриму, що наноситься на обличчя під час накладання цього заклинання</p>
          <p className="popup-subhead">Опис</p>
          <p>У точці, обраній вами в межах дистанції, з'являється примарна рука, що ширяє. Рука існує, поки заклинання активне, або поки ви не відпустите її дією. Рука зникає, якщо опиниться більш ніж за 30 футів від вас, або якщо ви повторно використовуєте це заклинання.</p>
          <p>Ви можете дією контролювати руку. Ви можете з її допомогою маніпулювати предметами, відчиняти незамкнені двері та контейнери, прибирати предмети у відкриті контейнери та діставати їх звідти, або виливати вміст флаконів.</p>
          <p>При кожному використанні руки ви можете перемістити її на 30 футів. Рука не може здійснювати атаки, активувати магічні предмети і переносити більше 10 фунтів.</p>
          <div className="popup-classes-container">
            <p className="popup-subhead">Класи</p>
            <div className="popup-classes">
              <BardLink />
