...
import WarlockCharmMagicInspiration from "./abilities/WarlockCharmMagicInspiration";
...
export default function WarlockCharmAbilities({ render }: { render: boolean }) {
  ...
  return render ? (
    <>
      ...
      >
        <Ability
          children={<><WarlockCharmMagicInspiration /></>}
          bg={abBg.magicInspiration}
          heading="Уміння варвара"
          lvl="2-й рівень"
          abName="Чарівне Натхнення (CHARM)"
          renderAb={renderAb}
