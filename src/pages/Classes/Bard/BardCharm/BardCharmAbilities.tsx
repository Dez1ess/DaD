...
import BardCharmHits from "./abilities/BardCharmHits";
import BardCharmAssets from "./abilities/BardCharmAssets";
import BardCharmEquipment from "./abilities/BardCharmEquipment";
...
export default function BardCharmAbilities({ render }: { render: boolean }) {
  ...
  return render ? (
    <>
      <ClassesBottomNavBar
        path1="/BardAbilities?option=5"
        path2="/BardDescriptions?option=5"
        path3="/BardSpells?option=5"
        path4="/BardImgs?option=5"
      />
      <div
