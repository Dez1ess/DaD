...
import BardCreationBuff from "./abilities/BardCreationBuff";
import BardCreationCompetence from "./abilities/BardCreationCompetence";
import BardCreationMaster from "./abilities/BardCreationMaster";
import BardCreationSong from "./abilities/BardCreationSong";
...
export default function BardCreationAbilities({ render }: { render: boolean }) {
  ...
  return render ? (
    <>
      <ClassesBottomNavBar
        path1="/BardAbilities?option=7"
        path2="/BardDescriptions?option=7"
        path3="/BardSpells?option=7"
        path4="/BardImgs?option=7"
      />
      <div
      ...
      >
        <Ability
          children={<><BardCreationMaster /></>}
          bg={abBg.master}
          img={abImg.master}
          heading="Уміння барда"
          lvl="2-й рівень"
          abName="Майстер на Всі Руки (creation)"
          renderAb={renderAb}
          handleRenderAb={handleRenderAb}
        />
        <Ability
          children={<><BardCreationSong /></>}
          bg={abBg.song}
          img={abImg.song}
          heading="Уміння барда"
          lvl="2-й рівень"
        ...
        />
        <Ability
          children={<><BardCreationCompetence /></>}
          bg={abBg.competence}
