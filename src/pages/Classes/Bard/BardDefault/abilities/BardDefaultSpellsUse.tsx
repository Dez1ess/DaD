...
export default function BardDefaultSpellsUse() {
  return (
    <>
      <div className="ab-wrapper">
        ...
        <p>
          Ви знаєте дві змови зі списку доступних для барда на ваш вибір. При
        ...
        <p>
          ...
          та інших рівнів. Для використання заклинань барда ви повинні витратити
          осередок відповідного рівня або рівня, що перевищує його. Ви
        ...
        <p>
          ...
          рівень у цьому класі, ви можете одне з відомих вам заклинань барда
          замінити на інше зі списку барда, рівень якого теж повинен відповідати
          наявним осередкам заклинань.
        </p>
        ...
        <p>
          Ви можете виконати будь-яке відоме вам заклинання барда як ритуал,
