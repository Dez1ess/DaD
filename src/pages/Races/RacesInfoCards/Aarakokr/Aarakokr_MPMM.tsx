...
export default function Aarakokr_MPMM() {
  const linkFolders = (
    <>
  ...
  const option1 = (<><RacesStats name="Гуманоїд" addition="Спр +2, Мдр +1" size="Середній" speed="25 футів" sight="Відсутній" />
  </>)
    ...
    <>
      ...
      <div className='wrapper' style={{paddingTop: "45px"}}>
        ...
        <div className='race-books'>
          <Link to="/Aarakokr_EV" className="book">EV</Link>
          <Link to="/Aarakokr_MPMM" className="book active-book">MPMM</Link>
        </div>
        {option1}
