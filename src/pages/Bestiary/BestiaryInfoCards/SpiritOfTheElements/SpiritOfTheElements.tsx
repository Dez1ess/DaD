...
export default function SpiritOfTheElements() {
  const linkFolders = (
    <>
      ...
      <span className="vertical-split">|</span>
      <Link to="" style={{ color: '#000', pointerEvents: 'none' }}>Дух Сти...</Link>
    </>
  )
  ...
  return (
    <>
      ...
      <BestiaryBottomNavBar path1='/SpiritOfTheElements' path2='/SpiritOfTheElementsImg' />
